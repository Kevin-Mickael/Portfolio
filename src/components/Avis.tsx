...
export const reviewsJsonLd = {
  ...
  review: reviewsData.map((review, i) => ({
    '@type': 'Review',
    author: {
      '@type': 'Person',
      name: review.name,
      ...
      <div className={styles.container + ' ' + styles.centered}>
        <div className={styles.header}>
          <div className={styles.avisTitle}>
            <h2 className={styles.avisTitleStrong}>EXCELLENT</h2>
            <div className={styles.avisStars} role="img" aria-label="Note de 4.5 sur 5">
              {[...Array(4)].map((_, i) => (
                <Image 
                  key={i}
            ...
            <div className={styles.avisSubtitle}>Basé sur <strong>{reviewsData.length} avis</strong></div>
          </div>
        ...
        <div className={styles.reviewsContainer}>
          <div className={styles.reviewsWrapper}>
            <div className={styles.reviewsTrack + ' hide-scrollbar'}>
                    ...
                    <div className={styles.reviewInner}>
                      ...
                      <div className={styles.reviewHeader}>
                        ...
                        <div className={styles.profileDetails}>
                          ...
                          <div className={styles.date}>{new Date(review.date).toLocaleDateString('fr-FR')}</div>
                        </div>
                      </div>
                      <div className={styles.stars} role="img" aria-label={`Note de ${review.stars} sur 5`}>
